...
<div class="container col-6">
    ...
    @endif
    <h3 class="fs-4 text-secondary my-4 text-center"><strong>Project Name:</strong> {{ $project->title }}</h3>
    <div class="d-flex justify-content-center">
        <img src="{{asset('storage/' . $project->image)}}" alt="{{ $project->title }}" style="width: 450px; height: 450px; border-radius: 15px;">
    </div>
    <div class="d-flex justify-content-center">
        <div class="py-4">
